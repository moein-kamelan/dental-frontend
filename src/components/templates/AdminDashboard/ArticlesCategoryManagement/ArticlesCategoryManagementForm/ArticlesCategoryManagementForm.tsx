...
function ArticlesCategoryManagementForm({
  category,
}: {
  ...
  const { mutateAsync: createCategory } = useCreateArticleCategory();
  const { mutateAsync: updateCategory } = useUpdateArticleCategory();
...
export default ArticlesCategoryManagementForm;
