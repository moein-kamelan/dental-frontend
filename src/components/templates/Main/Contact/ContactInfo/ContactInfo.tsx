      ...
      <div className="container mx-auto px-4 overflow-x-hidden">
        ...
        >
          <div className="bg-white rounded-2xl p-6 text-center   border-2 border-[rgba(94,91,91,0.09)]">
            ...
            <h4 className="font-estedad-semibold text-dark text-2xl mb-3 ">
              آدرس شرکت
            </h4>
            <p className="text-paragray font-estedad-light text-sm xl:text-base">
              فارس.شیراز.بلوار نیایش.ساختمان پرشکان
            </p>
          </div>
