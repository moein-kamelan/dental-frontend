        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-8 items-center h-full">
          ...
          >
            ...
            <button
              ...
              className="main-btn group/btn relative flex items-center justify-center lg:text-xs xl:text-sm text-nowrap max-md:mx-auto"
            >
          ...
          >
            {isBannersLoading ? (
              ...
              // PERFORMANCE: Fallback image without Swiper for faster LCP
              <div className="relative w-full h-full flex items-end justify-center">
                <img
                  src="/images/doctor_banner.png"
                  alt="دکتر متخصص کلینیک دندانپزشکی طاها"
