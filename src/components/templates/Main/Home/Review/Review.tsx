    ...
    <section className="py-16 md:py-20 lg:py-24 bg-gradient-to-br from-accent/10 via-primary/5 to-secondary/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
            ...
            viewport={{ once: true }}
          >
            <span className="inline-flex items-center gap-2 px-6 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-accent/20 text-accent font-estedad-semibold shadow-md">
