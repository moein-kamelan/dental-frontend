function WarnToast({ message }: { message: string }) {
  return (
    <div className="bg-white/95 backdrop-blur-md border border-amber-500/60 rounded-xl shadow-lg px-4 py-3.5 flex items-center gap-3 min-w-[320px] max-w-md group hover:shadow-xl transition-all duration-300">
      {/* Icon Container */}
