        ...
        >
          ...
          <div className="flex-1 w-full lg:w-auto order-1 lg:order-1 min-w-0">
            ...
            >
              {/* Compact Page Title */}
              <motion.h1
                className="text-xl md:text-2xl lg:text-3xl font-bold text-dark tracking-tight"
          ...
          >
              ...
              {breadcrumbItems.map((item, index) => (
                ...
                >
                  {index > 0 && (
                        <motion.span
                          className="text-gray-400 text-[10px] mx-0.5"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                  ...
                  {item.path ? (
                    <NavLink
                      to={item.path}
                          className="group relative text-xs md:text-sm text-gray-600 hover:text-dark transition-colors duration-200 font-medium"
                    >
                        ...
                        {item.label}
                          ...
                          <span className="absolute bottom-0 right-0 left-0 h-0.5 bg-accent scale-x-0 group-hover:scale-x-100 transition-transform duration-200 origin-right"></span>
                    </NavLink>
                  ) : (
                    <motion.span
