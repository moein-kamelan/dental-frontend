...
function Topbar() {
  ...
  return (
    <section className="bg-linear-to-l overflow-hidden from-primary to-accent text-white block h-11 font-estedad-medium">
      <div className="container mx-auto px-4 h-full">
        <div className="flex flex-wrap justify-center lg:justify-between items-center gap-2 h-full">
          <div className="flex items-center gap-4">
            {/* Toggle button for switching between clinics */}
            {hasTwoClinics && (
              <button
                onClick={handleToggleClinic}
                className="flex items-center gap-1 md:gap-2 px-2 md:px-3 py-1 rounded-md hover:bg-white/10 transition-colors text-xs md:text-sm leading-none"
            ...
            {/* Mobile: Show phone number + clinic name */}
            <div className="flex md:hidden items-center gap-2 text-sm leading-none">
              {phoneNumber && (
              ...
              {activeClinic && (
                <span className="text-xs opacity-90">- {activeClinic.name}</span>
              )}
            </div>
            
            {/* Desktop: Show full contact info */}
            <ul className="hidden md:flex flex-wrap gap-6 text-sm leading-none">
              {phoneNumber && (
          ...
          <ul className="hidden lg:flex flex-wrap gap-4 items-center">
            {facebook && (
              <li>
                <a href={facebook} target="_blank" rel="noopener noreferrer" className="flex items-center">
            ...
            {twitter && (
              <li>
                <a href={twitter} target="_blank" rel="noopener noreferrer" className="flex items-center">
            ...
            {youtube && (
              <li>
                <a href={youtube} target="_blank" rel="noopener noreferrer" className="flex items-center">
            ...
            {instagram && (
              <li>
                <a href={instagram} target="_blank" rel="noopener noreferrer" className="flex items-center">
