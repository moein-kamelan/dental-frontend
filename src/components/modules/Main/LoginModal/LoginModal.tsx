        ...
        <>
          ...
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none">
            <motion.div
              ...
              className="relative bg-gray-100 ring-2 border-dark rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full pointer-events-auto max-h-[90vh] overflow-y-auto"
            >
          {/* Close Button */}
          <button
            onClick={closeModal}
            className="absolute top-4 right-6 flex items-center justify-center rounded-full p-5 bg-accent hover:bg-secondary transition-colors z-10"
          >
            <i className="fas fa-times text-2xl text-white absolute"></i>
          </button>
          ...
          {authStep === 2 && (
            <button
              ...
              className="absolute top-4 left-6 flex items-center justify-center rounded-full p-5 bg-accent hover:bg-secondary transition-colors"
            >
