...
function AboutUsSection() {
  return (
    <section className="py-20 md:py-24 relative overflow-x-hidden">
      <img
        ...
        <div className="grid xl:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative md:left-20 md:top-1/2 min-w-[280px] max-h-[400px]">
              ...
              <a
                href="#"
                className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-40 rounded-2xl hover:bg-opacity-50 transition"
              >
                <i className="fas fa-play text-white text-4xl"></i>
              </a>

              <img
                src="/images/about_shape1.png"
                alt="shape"
                className="hidden md:block absolute -top-30 size-20 circular-animation left-10"
              />
            </div>
          </motion.div>
