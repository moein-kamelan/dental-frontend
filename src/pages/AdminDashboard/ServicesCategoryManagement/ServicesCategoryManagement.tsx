...
import ServicesCategoryManagementTable from "../../../components/templates/AdminDashboard/ServicesCategoryManagement/ServicesCategoryManagementTable/ServicesCategoryManagementTable";
...
function ServicesCategoryManagement() {
  ...
  const { mutateAsync: deleteCategory } = useDeleteServiceCategory();
  const {
    data: categoriesData,
  ...
  return (
    <main>
      <SectionContainer>
        ...
        <ServicesCategoryManagementTable
        ...
        <ServicesCategoryManagementForm />
      </SectionContainer>
      <DeleteModal
