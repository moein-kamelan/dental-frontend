...
function Blog() {
  ...
  return (
    <>
      <SEO
        title="مقالات و اخبار دندانپزشکی - کلینیک دندان پزشکی طاها"
        ...
        keywords="مقالات دندانپزشکی, اخبار دندانپزشکی, مراقبت از دندان, سلامت دهان و دندان, مقالات کلینیک طاها"
        url="/blog"
      />
