...
function Contact() {
  ...
  return (
    <>
      <SEO
        title="تماس با ما - کلینیک دندان پزشکی طاها"
        description="تماس با کلینیک دندان پزشکی طاها - آدرس، شماره تماس، ایمیل و موقعیت کلینیک‌های ما. برای دریافت نوبت و مشاوره با ما تماس بگیرید"
        keywords="تماس با ما, آدرس کلینیک, شماره تماس, موقعیت کلینیک, کلینیک طاها"
        url="/contact"
      />
      <Breadcrumb />
