...
function Services() {
  ...
  return (
    <>
      <SEO
        title="خدمات دندانپزشکی - کلینیک دندان پزشکی طاها"
        description="لیست کامل خدمات دندانپزشکی کلینیک طاها شامل: ایمپلنت، ارتودنسی، زیبایی دندان، لمینت، کامپوزیت و سایر خدمات تخصصی"
        keywords="خدمات دندانپزشکی, ایمپلنت, ارتودنسی, زیبایی دندان, لمینت, کامپوزیت, خدمات کلینیک طاها"
        url="/services"
      />
