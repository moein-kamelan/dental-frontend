...
function FAQ() {
  ...
  return (
    <>
      <SEO
        title="سوالات متداول (FAQ) - کلینیک دندان پزشکی طاها"
        description="پاسخ به سوالات متداول در مورد خدمات دندانپزشکی، نوبت‌دهی، هزینه‌ها و سایر سوالات رایج در کلینیک دندان پزشکی طاها"
        keywords="سوالات متداول, FAQ, پرسش و پاسخ, سوالات دندانپزشکی, کلینیک طاها"
        url="/faq"
      />
      <Breadcrumb />
