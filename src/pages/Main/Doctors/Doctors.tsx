...
function Doctors() {
  ...
  return (
    <>
      <SEO
        title="لیست پزشکان - کلینیک دندان پزشکی طاها"
        description="لیست کامل پزشکان و متخصصین کلینیک دندان پزشکی طاها. مشاهده پروفایل، تخصص و تجربه پزشکان ما"
        keywords="دندانپزشک, لیست پزشکان, متخصص دندانپزشکی, پزشکان کلینیک طاها"
        url="/doctors"
      />
